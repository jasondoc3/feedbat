...
$(document).ready(function() {
	$.cloudinary.config({ cloud_name: "dpt2fwlws", api_key: '759462599376438' });
	$('#upload_image').unsigned_cloudinary_upload("hbgwfkge", { cloud_name: 'dpt2fwlws'}).bind('cloudinarydone', afterPhotoUpload);
